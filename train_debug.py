...
def train_pipeline(root_path, data_type):
    # parse options, set distributed setting, set random seed
    opt = parse_options_debug(root_path, data_type, is_train=True)
...
if __name__ == '__main__':
    ...
    data_types ={'scape'}  #faust
    for data_type in data_types:
        train_pipeline(root_path, data_type)
